...
const NavBar = () => {
  return (
    <Wrapper>
      <LeftLinks>
        <Link href="#">SHOP ALL</Link> {/* Cambiar por un Link de React Router */}
        <Link href="#">MEN'S</Link> {/* Cambiar por un Link de React Router */}
        <Link href="#">WOMEN'S</Link> {/* Cambiar por un Link de React Router */}
        <Link href="#">KIDS</Link> {/* Cambiar por un Link de React Router */}
        <Link href="#">ACCESORIES</Link> {/* Cambiar por un Link de React Router */}
      </LeftLinks>
